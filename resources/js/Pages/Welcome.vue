...
<template>
  ...
  <div class="min-h-screen bg-wisal-ivory text-wisal-charcoal flex flex-col font-sans">
    <header class="border-b border-wisal-beige/30 py-4 bg-white/50 backdrop-blur-md sticky top-0 z-50">
      <div class="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav class="space-x-4 space-x-reverse text-sm">
          <a href="#" class="hover:text-wisal-aqua transition-colors duration-200">الرئيسية</a>
          <a href="#" class="hover:text-wisal-aqua transition-colors duration-200">الكتالوج</a>
          <a href="#" class="hover:text-wisal-aqua transition-colors duration-200">المدونة</a>
        </nav>
      </div>
    </header>
    ...
    <main class="flex-grow flex items-center justify-center p-8">
      <div class="text-center max-w-md bg-white p-8 rounded-2xl shadow-sm border border-wisal-beige/20">
        ...
        <h2 class="text-2xl font-bold mb-2">متجر وِصال</h2>
        <p class="text-gray-500 mb-6 text-sm">بين كل هدية وذكرى — وِصال</p>
    ...
    <footer class="border-t border-wisal-beige/20 py-6 text-center text-xs text-gray-400 bg-white/35">
      <p>&copy; 2026 متجر وِصال. جميع الحقوق محفوظة.</p>
    </footer>
  </div>
</template>
